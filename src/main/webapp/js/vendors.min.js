        ...
        1: [function(e, t, a) {
            !function(e, t) {
                ...
                var t = {
                    ...
                    setVendor: function(e, t, a) {
                        e && (e.style[t.charAt(0).toLowerCase() + t.slice(1)] = a,
                        e.style["webkit" + t] = a,
                        e.style["moz" + t] = a,
                        e.style["ms" + t] = a,
                        e.style["o" + t] = a)
                    ...
                    on: function(e, a, i) {
                        var s = this;
                        e && a.split(" ").forEach((function(a) {
                            var r = s.getAttribute(e, "lg-event-uid") || "";
                            t.Listener.uid++,
                            r += "&" + t.Listener.uid,
                            s.setAttribute(e, "lg-event-uid", r),
                            t.Listener[a + t.Listener.uid] = i,
                            e.addEventListener(a.split(".")[0], i, !1)
                        }
                        ))
                    },
                    off: function(e, a) {
                            ...
                            if (i) {
                                ...
                                for (var s = 0; s < i.length; s++)
                                    if (i[s]) {
                                        var r = a + i[s];
                                        if ("." === r.substring(0, 1))
                                            for (var n in t.Listener)
                                                t.Listener.hasOwnProperty(n) && n.split(".").indexOf(r.split(".")[1]) > -1 && (e.removeEventListener(n.split(".")[0], t.Listener[n]),
                                                this.setAttribute(e, "lg-event-uid", this.getAttribute(e, "lg-event-uid").replace("&" + i[s], "")),
                                                delete t.Listener[n]);
                                        else
        ...
        2: [function(e, t, a) {
            !function(t, i) {
                ...
                t.prototype.init = function() {
                    ...
                    a.default.addClass(document.body, "lg-from-hash"),
                    a.default.hasClass(document.body, "lg-on") || (a.default.addClass(document.body, "lg-on"),
                    setTimeout((function() {
                        e.build(e.index)
                    }
                    )))),
                    e.s.dynamic)
                        a.default.trigger(this.el, "onBeforeOpen"),
                        e.index = e.s.index || 0,
                        a.default.hasClass(document.body, "lg-on") || (a.default.addClass(document.body, "lg-on"),
                        setTimeout((function() {
                            e.build(e.index)
                        ...
                        for (var i = 0; i < e.items.length; i++)
                            !function(t) {
                                a.default.on(e.items[t], "click.lgcustom", (function(i) {
                                    i.preventDefault(),
                                    a.default.trigger(e.el, "onBeforeOpen"),
                                    e.index = e.s.index || t,
                                    a.default.hasClass(document.body, "lg-on") || (e.build(e.index),
                                    a.default.addClass(document.body, "lg-on"))
                                }
                                ))
                            }(i)
                }
                ...
                t.prototype.build = function(e) {
                    ...
                    t.counter(),
                    t.closeGallery(),
                    a.default.trigger(t.el, "onAfterOpen"),
                    a.default.on(t.outer, "mousemove.lg click.lg touchstart.lg", (function() {
                        a.default.removeClass(t.outer, "lg-hide-items"),
                        clearTimeout(t.hideBartimeout),
                        t.hideBartimeout = setTimeout((function() {
                            a.default.addClass(t.outer, "lg-hide-items")
                        }
                        ), t.s.hideBarsDelay)
                    }
                    ))
                ...
                t.prototype.structure = function() {
                    var e, t = "", i = "", s = 0, r = "", n = this;
                    for (document.body.insertAdjacentHTML("beforeend", '<div class="lg-backdrop"></div>'),
                    a.default.setVendor(document.querySelector(".lg-backdrop"), "TransitionDuration", this.s.backdropDuration + "ms"),
                    s = 0; s < this.items.length; s++)
                        t += '<div class="lg-item"></div>';
                    if (this.s.controls && this.items.length > 1 && (i = '<div class="lg-actions"><div class="lg-prev lg-icon">' + this.s.prevHtml + '</div><div class="lg-next lg-icon">' + this.s.nextHtml + "</div></div>"),
                    ".lg-sub-html" === this.s.appendSubHtmlTo && (r = '<div class="lg-sub-html"></div>'),
                    e = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + t + '</div><div class="lg-toolbar group"><span class="lg-close lg-icon"></span></div>' + i + r + "</div></div>",
                    document.body.insertAdjacentHTML("beforeend", e),
                    this.outer = document.querySelector(".lg-outer"),
                    this.___slide = this.outer.querySelectorAll(".lg-item"),
                    this.s.useLeft ? (a.default.addClass(this.outer, "lg-use-left"),
                    this.s.mode = "lg-slide") : a.default.addClass(this.outer, "lg-use-css3"),
                    n.setTop(),
                    a.default.on(window, "resize.lg orientationchange.lg", (function() {
                        setTimeout((function() {
                            n.setTop()
                        }
                        ), 100)
                    ...
                    a.default.addClass(this.___slide[this.index], "lg-current"),
                    this.doCss() ? a.default.addClass(this.outer, "lg-css3") : (a.default.addClass(this.outer, "lg-css"),
                    this.s.speed = 0),
                    a.default.addClass(this.outer, this.s.mode),
                    this.s.enableDrag && this.items.length > 1 && a.default.addClass(this.outer, "lg-grab"),
                    this.s.showAfterLoad && a.default.addClass(this.outer, "lg-show-after-load"),
                    this.doCss()) {
                        var l = this.outer.querySelector(".lg-inner");
                        a.default.setVendor(l, "TransitionTimingFunction", this.s.cssEasing),
                        a.default.setVendor(l, "TransitionDuration", this.s.speed + "ms")
                    }
                    setTimeout((function() {
                        a.default.addClass(document.querySelector(".lg-backdrop"), "in")
                    }
                    )),
                    setTimeout((function() {
                        a.default.addClass(n.outer, "lg-visible")
                    }
                ...
                t.prototype.setTop = function() {
                    if ("100%" !== this.s.height) {
                        var e = window.innerHeight
                          ...
                          , a = this.outer.querySelector(".lg");
                        e >= parseInt(this.s.height, 10) ? a.style.top = t + "px" : a.style.top = "0px"
                    }
                }
                ,
                ...
                t.prototype.isVideo = function(e, t) {
                    var a;
                    if (a = this.s.dynamic ? this.s.dynamicEl[t].html : this.items[t].getAttribute("data-html"),
                    !e && a)
                        return {
                            html5: !0
                        };
                ...
                t.prototype.addHtml = function(e) {
                    ...
                    null != i) {
                        ...
                        "." !== s && "#" !== s || (i = this.s.subHtmlSelectorRelative && !this.s.dynamic ? t.querySelector(i).innerHTML : document.querySelector(i).innerHTML)
                    } else
                        i = "";
                    ...
                    null != i && ("" === i ? a.default.addClass(this.outer.querySelector(this.s.appendSubHtmlTo), "lg-empty-html") : a.default.removeClass(this.outer.querySelector(this.s.appendSubHtmlTo), "lg-empty-html")),
                    a.default.trigger(this.el, "onAfterAppendSubHtml", {
                        index: e
                    })
                }
                ,
                t.prototype.preload = function(e) {
                    ...
                    for (a = 1; a <= this.s.preload && !(e - a < 0); a++)
                        this.loadContent(e - a, !1, 0)
                }
                ,
                t.prototype.loadContent = function(e, t, i) {
                    var s, r, n, l, o, d, u = this, c = !1, p = function(e) {
                    ...
                    u.s.dynamic ? (u.s.dynamicEl[e].poster && (c = !0,
                    n = u.s.dynamicEl[e].poster),
                    d = u.s.dynamicEl[e].html,
                    r = u.s.dynamicEl[e].src,
                    u.s.dynamicEl[e].responsive && p(u.s.dynamicEl[e].responsive.split(",")),
                    l = u.s.dynamicEl[e].srcset,
                    o = u.s.dynamicEl[e].sizes) : (u.items[e].getAttribute("data-poster") && (c = !0,
                    n = u.items[e].getAttribute("data-poster")),
                    d = u.items[e].getAttribute("data-html"),
                    r = u.items[e].getAttribute("href") || u.items[e].getAttribute("data-src"),
                    u.items[e].getAttribute("data-responsive") && p(u.items[e].getAttribute("data-responsive").split(",")),
                    l = u.items[e].getAttribute("data-srcset"),
                    o = u.items[e].getAttribute("data-sizes"));
                    var h = !1;
                    u.s.dynamic ? u.s.dynamicEl[e].iframe && (h = !0) : "true" === u.items[e].getAttribute("data-iframe") && (h = !0);
                    var f = u.isVideo(r, e);
                    if (!a.default.hasClass(u.___slide[e], "lg-loaded")) {
                        if (h)
                            ...
                            u.___slide[e].insertAdjacentHTML("beforeend", '<div class="lg-video-cont ' + m + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + n + '" /></div></div>')
                        } else
                            f ? (u.___slide[e].insertAdjacentHTML("beforeend", '<div class="lg-video-cont "><div class="lg-video"></div></div>'),
                            a.default.trigger(u.el, "hasVideo", {
                                index: e,
                                src: r,
                                html: d
                            })) : u.___slide[e].insertAdjacentHTML("beforeend", '<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + r + '" /></div>');
                        if (a.default.trigger(u.el, "onAferAppendSlide", {
                            index: e
                        }),
                        s = u.___slide[e].querySelector(".lg-object"),
                        o && s.setAttribute("sizes", o),
                        l) {
                            s.setAttribute("srcset", l);
                            try {
                                picturefill({
                                    elements: [s[0]]
                                })
                        ...
                        a.default.addClass(u.___slide[e], "lg-loaded")
                    }
                    a.default.on(u.___slide[e].querySelector(".lg-object"), "load.lg error.lg", (function() {
                        var t = 0;
                        i && !a.default.hasClass(document.body, "lg-from-hash") && (t = i),
                        setTimeout((function() {
                            a.default.addClass(u.___slide[e], "lg-complete"),
                            a.default.trigger(u.el, "onSlideItemLoad", {
                                index: e,
                                delay: i || 0
                            })
                        }
                    ...
                    f && f.html5 && !c && a.default.addClass(u.___slide[e], "lg-complete"),
                    !0 === t && (a.default.hasClass(u.___slide[e], "lg-complete") ? u.preload(e) : a.default.on(u.___slide[e].querySelector(".lg-object"), "load.lg error.lg", (function() {
                        u.preload(e)
                    }
                    )))
                }
                ...
                t.prototype.slide = function(e, t, i) {
                    for (var s = 0, r = 0; r < this.___slide.length; r++)
                        if (a.default.hasClass(this.___slide[r], "lg-current")) {
                            s = r;
                            break
                        }
                    var n = this;
                    if (!n.lGalleryOn || s !== e) {
                        var l = this.___slide.length
                          , o = n.lGalleryOn ? this.s.speed : 0
                          , d = !1
                          , u = !1;
                        if (!n.lgBusy) {
                            var c;
                            if (this.s.download)
                                (c = n.s.dynamic ? !1 !== n.s.dynamicEl[e].downloadUrl && (n.s.dynamicEl[e].downloadUrl || n.s.dynamicEl[e].src) : "false" !== n.items[e].getAttribute("data-download-url") && (n.items[e].getAttribute("data-download-url") || n.items[e].getAttribute("href") || n.items[e].getAttribute("data-src"))) ? (document.getElementById("lg-download").setAttribute("href", c),
                                a.default.removeClass(n.outer, "lg-hide-download")) : a.default.addClass(n.outer, "lg-hide-download");
                            if (a.default.trigger(n.el, "onBeforeSlide", {
                                prevIndex: s,
                                index: e,
                                fromTouch: t,
                                fromThumb: i
                            ...
                            t) {
                                var p = e - 1
                                  , h = e + 1;
                                (0 === e && s === l - 1 || e === l - 1 && 0 === s) && (h = 0,
                                p = l - 1),
                                a.default.removeClass(n.outer.querySelector(".lg-prev-slide"), "lg-prev-slide"),
                                a.default.removeClass(n.outer.querySelector(".lg-current"), "lg-current"),
                                a.default.removeClass(n.outer.querySelector(".lg-next-slide"), "lg-next-slide"),
                                a.default.addClass(n.___slide[p], "lg-prev-slide"),
                                a.default.addClass(n.___slide[h], "lg-next-slide"),
                                a.default.addClass(n.___slide[e], "lg-current")
                            } else {
                                a.default.addClass(n.outer, "lg-no-trans");
                                for (var f = 0; f < this.___slide.length; f++)
                                    a.default.removeClass(this.___slide[f], "lg-prev-slide"),
                                    a.default.removeClass(this.___slide[f], "lg-next-slide");
                                e < s ? (u = !0,
                                0 !== e || s !== l - 1 || i || (u = !1,
                                d = !0)) : e > s && (d = !0,
                                e !== l - 1 || 0 !== s || i || (u = !0,
                                d = !1)),
                                u ? (a.default.addClass(this.___slide[e], "lg-prev-slide"),
                                a.default.addClass(this.___slide[s], "lg-next-slide")) : d && (a.default.addClass(this.___slide[e], "lg-next-slide"),
                                a.default.addClass(this.___slide[s], "lg-prev-slide")),
                                setTimeout((function() {
                                    a.default.removeClass(n.outer.querySelector(".lg-current"), "lg-current"),
                                    a.default.addClass(n.___slide[e], "lg-current"),
                                    a.default.removeClass(n.outer, "lg-no-trans")
                                }
                                ), 50)
                            }
                            ...
                            setTimeout((function() {
                                n.lgBusy = !1,
                                a.default.trigger(n.el, "onAfterSlide", {
                                    prevIndex: s,
                                    index: e,
                                    fromTouch: t,
                                    fromThumb: i
                            ...
                            ), this.s.speed)) : (n.loadContent(e, !0, n.s.backdropDuration),
                            n.lgBusy = !1,
                            a.default.trigger(n.el, "onAfterSlide", {
                                prevIndex: s,
                                index: e,
                ...
                t.prototype.goToNextSlide = function(e) {
                    ...
                    a.default.trigger(t.el, "onBeforeNextSlide", {
                        index: t.index
                    }),
                    ...
                    t.slide(t.index, e, !1)) : t.s.slideEndAnimatoin && (a.default.addClass(t.outer, "lg-right-end"),
                    setTimeout((function() {
                        a.default.removeClass(t.outer, "lg-right-end")
                    }
                    ), 400)))
                }
                ,
                t.prototype.goToPrevSlide = function(e) {
                    ...
                    a.default.trigger(t.el, "onBeforePrevSlide", {
                        index: t.index,
                        fromTouch: e
                    }),
                    ...
                    t.slide(t.index, e, !1)) : t.s.slideEndAnimatoin && (a.default.addClass(t.outer, "lg-left-end"),
                    setTimeout((function() {
                        a.default.removeClass(t.outer, "lg-left-end")
                    }
                    ), 400)))
                }
                ,
                t.prototype.keyPress = function() {
                    var e = this;
                    this.items.length > 1 && a.default.on(window, "keyup.lg", (function(t) {
                    ...
                    a.default.on(window, "keydown.lg", (function(t) {
                        !0 === e.s.escKey && 27 === t.keyCode && (t.preventDefault(),
                        a.default.hasClass(e.outer, "lg-thumb-open") ? a.default.removeClass(e.outer, "lg-thumb-open") : e.destroy())
                    }
                    ))
                }
                ,
                t.prototype.arrow = function() {
                    var e = this;
                    a.default.on(this.outer.querySelector(".lg-prev"), "click.lg", (function() {
                        e.goToPrevSlide()
                    }
                    )),
                    a.default.on(this.outer.querySelector(".lg-next"), "click.lg", (function() {
                        e.goToNextSlide()
                    }
                    ))
                }
                ...
                t.prototype.arrowDisable = function(e) {
                    if (!this.s.loop && this.s.hideControlOnEnd) {
                        ...
                        a.default.removeClass(t, "disabled")) : (t.setAttribute("disabled", "disabled"),
                        a.default.addClass(t, "disabled")),
                        e > 0 ? (i.removeAttribute("disabled"),
                        a.default.removeClass(i, "disabled")) : (i.setAttribute("disabled", "disabled"),
                        a.default.addClass(i, "disabled"))
                    }
                }
                ,
                t.prototype.setTranslate = function(e, t, i) {
                    this.s.useLeft ? e.style.left = t : a.default.setVendor(e, "Transform", "translate3d(" + t + "px, " + i + "px, 0px)")
                }
                ,
                t.prototype.touchMove = function(e, t) {
                    var i = t - e;
                    Math.abs(i) > 15 && (a.default.addClass(this.outer, "lg-dragging"),
                ...
                t.prototype.touchEnd = function(e) {
                    var t = this;
                    "lg-slide" !== t.s.mode && a.default.addClass(t.outer, "lg-slide");
                    for (var i = 0; i < this.___slide.length; i++)
                        a.default.hasClass(this.___slide[i], "lg-current") || a.default.hasClass(this.___slide[i], "lg-prev-slide") || a.default.hasClass(this.___slide[i], "lg-next-slide") || (this.___slide[i].style.opacity = "0");
                    setTimeout((function() {
                        a.default.removeClass(t.outer, "lg-dragging"),
                        e < 0 && Math.abs(e) > t.s.swipeThreshold ? t.goToNextSlide(!0) : e > 0 && Math.abs(e) > t.s.swipeThreshold ? t.goToPrevSlide(!0) : Math.abs(e) < 5 && a.default.trigger(t.el, "onSlideClick");
                        for (var i = 0; i < t.___slide.length; i++)
                            t.___slide[i].removeAttribute("style")
                    }
                    )),
                    setTimeout((function() {
                        a.default.hasClass(t.outer, "lg-dragging") || "lg-slide" === t.s.mode || a.default.removeClass(t.outer, "lg-slide")
                    }
                    ), t.s.speed + 100)
                }
                ,
                t.prototype.enableSwipe = function() {
                    ...
                    if (e.s.enableSwipe && e.isTouch && e.doCss()) {
                        for (var r = 0; r < e.___slide.length; r++)
                            a.default.on(e.___slide[r], "touchstart.lg", (function(i) {
                                a.default.hasClass(e.outer, "lg-zoomed") || e.lgBusy || (i.preventDefault(),
                                e.manageSwipeClass(),
                                t = i.targetTouches[0].pageX)
                            }
                            ));
                        for (var n = 0; n < e.___slide.length; n++)
                            a.default.on(e.___slide[n], "touchmove.lg", (function(r) {
                                a.default.hasClass(e.outer, "lg-zoomed") || (r.preventDefault(),
                        ...
                        for (var l = 0; l < e.___slide.length; l++)
                            a.default.on(e.___slide[l], "touchend.lg", (function() {
                                a.default.hasClass(e.outer, "lg-zoomed") || (s ? (s = !1,
                                e.touchEnd(i - t)) : a.default.trigger(e.el, "onSlideClick"))
                            }
                            ))
                    }
                }
                ...
                t.prototype.enableDrag = function() {
                    ...
                    if (e.s.enableDrag && !e.isTouch && e.doCss()) {
                        for (var n = 0; n < e.___slide.length; n++)
                            a.default.on(e.___slide[n], "mousedown.lg", (function(i) {
                                a.default.hasClass(e.outer, "lg-zoomed") || (a.default.hasClass(i.target, "lg-object") || a.default.hasClass(i.target, "lg-video-play")) && (i.preventDefault(),
                                e.lgBusy || (e.manageSwipeClass(),
                                t = i.pageX,
                                s = !0,
                                e.outer.scrollLeft += 1,
                                e.outer.scrollLeft -= 1,
                                a.default.removeClass(e.outer, "lg-grab"),
                                a.default.addClass(e.outer, "lg-grabbing"),
                                a.default.trigger(e.el, "onDragstart")))
                            }
                            ));
                        a.default.on(window, "mousemove.lg", (function(n) {
                            s && (r = !0,
                            i = n.pageX,
                            e.touchMove(t, i),
                            a.default.trigger(e.el, "onDragmove"))
                        }
                        )),
                        a.default.on(window, "mouseup.lg", (function(n) {
                            r ? (r = !1,
                            e.touchEnd(i - t),
                            a.default.trigger(e.el, "onDragend")) : (a.default.hasClass(n.target, "lg-object") || a.default.hasClass(n.target, "lg-video-play")) && a.default.trigger(e.el, "onSlideClick"),
                            s && (s = !1,
                            a.default.removeClass(e.outer, "lg-grabbing"),
                            a.default.addClass(e.outer, "lg-grab"))
                        }
                        ))
                    }
                }
                ...
                t.prototype.manageSwipeClass = function() {
                    ...
                    for (var s = 0; s < this.___slide.length; s++)
                        a.default.removeClass(this.___slide[s], "lg-next-slide"),
                        a.default.removeClass(this.___slide[s], "lg-prev-slide");
                    t > -1 && a.default.addClass(this.___slide[t], "lg-prev-slide"),
                    a.default.addClass(this.___slide[e], "lg-next-slide")
                }
                ,
                t.prototype.mousewheel = function() {
                    var e = this;
                    a.default.on(e.outer, "mousewheel.lg", (function(t) {
                ...
                t.prototype.closeGallery = function() {
                    var e = this
                      , t = !1;
                    a.default.on(this.outer.querySelector(".lg-close"), "click.lg", (function() {
                        e.destroy()
                    }
                    )),
                    e.s.closable && (a.default.on(e.outer, "mousedown.lg", (function(e) {
                        t = !!(a.default.hasClass(e.target, "lg-outer") || a.default.hasClass(e.target, "lg-item") || a.default.hasClass(e.target, "lg-img-wrap"))
                    }
                    )),
                    a.default.on(e.outer, "mouseup.lg", (function(i) {
                        (a.default.hasClass(i.target, "lg-outer") || a.default.hasClass(i.target, "lg-item") || a.default.hasClass(i.target, "lg-img-wrap") && t) && (a.default.hasClass(e.outer, "lg-dragging") || e.destroy())
                    }
                    )))
                }
                ,
                t.prototype.destroy = function(e) {
                    var t = this;
                    if (e || a.default.trigger(t.el, "onBeforeClose"),
                    document.body.scrollTop = t.prevScrollTop,
                    document.documentElement.scrollTop = t.prevScrollTop,
                    e) {
                        if (!t.s.dynamic)
                            for (var i = 0; i < this.items.length; i++)
                                a.default.off(this.items[i], ".lg"),
                                a.default.off(this.items[i], ".lgcustom");
                        var s = t.el.getAttribute("lg-uid");
                        delete window.lgData[s],
                        t.el.removeAttribute("lg-uid")
                    }
                    for (var r in a.default.off(this.el, ".lgtm"),
                    window.lgModules)
                        t.modules[r] && t.modules[r].destroy(e);
                    this.lGalleryOn = !1,
                    clearTimeout(t.hideBartimeout),
                    this.hideBartimeout = !1,
                    a.default.off(window, ".lg"),
                    a.default.removeClass(document.body, "lg-on"),
                    a.default.removeClass(document.body, "lg-from-hash"),
                    t.outer && a.default.removeClass(t.outer, "lg-visible"),
                    a.default.removeClass(document.querySelector(".lg-backdrop"), "in"),
                    setTimeout((function() {
                        try {
                            ...
                            e || a.default.trigger(t.el, "onCloseAfter")
                        } catch (e) {}
                    }
                    ), t.s.backdropDuration + 50)
                }
                ,
                window.lightGallery = function(e, a) {
                    if (e)
                        try {
...
function(e, t) {
    ...
    var g, y, b, w = {
            ...
            function l(e) {
                ...
                if (t) {
                    ...
                    v(t).is(s))
                        ...
                        for (var i = v(t).parents(), n = 0; n < i.length; n += 1)
                            v(i[n]).is(s) && r.apply(i[n], a)
                }
            }
            function o(e) {
                ...
                for (var d = l[o], u = 0; u < this.length; u += 1) {
                    ...
                    p && p.length)
                        for (var h = p.length - 1; h >= 0; h -= 1) {
                            ...
                            p.splice(h, 1)) : r || (c.removeEventListener(d, f.proxyListener, n),
                            p.splice(h, 1))
                        }
                }
            return this
        ...
        parent: function(e) {
            for (var t = [], a = 0; a < this.length; a += 1)
                null !== this[a].parentNode && (e ? v(this[a].parentNode).is(e) && t.push(this[a].parentNode) : t.push(this[a].parentNode));
            return v(t)
        },
        parents: function(e) {
            for (var t = [], a = 0; a < this.length; a += 1)
        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1) {
            ...
            if (null != a)
                for (var i = Object.keys(Object(a)), s = 0, r = i.length; s < r; s += 1) {
                    ...
                    void 0 !== l && l.enumerable && (T(e[n]) && T(a[n]) ? S(e[n], a[n]) : !T(e[n]) && T(a[n]) ? (e[n] = {},
                    S(e[n], a[n])) : e[n] = a[n])
                }
        }
        return e
    ...
    function k(e) {
        ...
        y || (y = function(e) {
            var t = (void 0 === e ? {} : e).userAgent
              ...
              , f = "Win32" === s
              , m = "MacIntel" === s;
            return !c && m && a.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(o + "x" + d) >= 0 && ((c = r.match(/(Version)\/([\d.]+)/)) || (c = [0, 1, "13_0_0"]),
            m = !1),
            u && !f && (n.os = "android",
            n.android = !0),
            (c || h || p) && (n.os = "ios",
    ...
    function _(e) {
        ...
        if (!t.animating || !n.preventInteractionOnTransition) {
            ...
            var u = v(d.target);
            if (("wrapper" !== n.touchEventsTarget || u.closest(t.wrapperEl).length) && (s.isTouchEvent = "touchstart" === d.type,
            (s.isTouchEvent || !("which"in d) || 3 !== d.which) && !(!s.isTouchEvent && "button"in d && d.button > 0 || s.isTouched && s.isMoved)))
                if (!!n.noSwipingClass && "" !== n.noSwipingClass && d.target && d.target.shadowRoot && e.path && e.path[0] && (u = v(e.path[0])),
                n.noSwiping && u.closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0])
                    ...
                    "touchstart" !== d.type) {
                        var m = !0;
                        u.is(s.formElements) && (m = !1),
                        a.activeElement && v(a.activeElement).is(s.formElements) && a.activeElement !== u[0] && a.activeElement.blur();
                        var g = m && t.allowTouchMove && n.touchStartPreventDefault;
                        !n.touchStartForcePreventDefault && !g || u[0].isContentEditable || d.preventDefault()
                    }
                    t.emit("touchStart", d)
                }
        }
            ...
            if (!i.isTouchEvent || "touchmove" === o.type) {
                ...
                if (i.isTouchEvent && s.touchReleaseOnEdges && !s.loop)
                    if (a.isVertical()) {
                        ...
                        return;
                if (i.isTouchEvent && t.activeElement && o.target === t.activeElement && v(o.target).is(i.formElements))
                    return i.isMoved = !0,
                    void (a.allowClick = !1);
                ...
                !(o.targetTouches && o.targetTouches.length > 1)) {
                    n.currentX = u,
                    n.currentY = c;
                    var p, h = n.currentX - n.startX, f = n.currentY - n.startY;
                    if (!(a.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(f, 2)) < a.params.threshold))
                        if (void 0 === i.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : h * h + f * f >= 25 && (p = 180 * Math.atan2(Math.abs(f), Math.abs(h)) / Math.PI,
                        ...
                        i.isScrolling)
                            ...
                            s.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + m, y))) : m < 0 && i.currentTranslate < a.maxTranslate() && (g = !1,
                            s.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - m, y))),
    ...
    function O(e) {
        ...
        var u, c = x(), p = c - a.touchStartTime;
            ...
            if (i.freeMode) {
                ...
                if (i.freeModeMomentum) {
                    if (a.velocities.length > 1) {
                        ...
                        (v > 150 || x() - h.time > 300) && (t.velocity = 0)
                    } else
                        t.velocity = 0;
                    ...
                    var g = 1e3 * i.freeModeMomentumRatio
                      ...
                      , b = t.translate + y;
                    r && (b = -b);
                    var w, C, T = !1, S = 20 * Math.abs(t.velocity) * i.freeModeMomentumBounceRatio;
                    if (b < t.maxTranslate())
                    ...
                    0 !== t.velocity) {
                        ...
                        i.freeModeSticky) {
                            ...
                            g = k < P ? i.speed : k < 2 * P ? 1.5 * i.speed : 2.5 * i.speed
                        }
                    } else if (i.freeModeSticky)
                ...
                for (var L = 0, $ = t.slidesSizesGrid[0], A = 0; A < l.length; A += A < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
                    var _ = A < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
                    void 0 !== l[A + _] ? u >= l[A] && u < l[A + _] && (L = A,
                    $ = l[A + _] - l[A]) : u >= l[A] && (L = A,
                    $ = l[l.length - 1] - l[l.length - 2])
                }
                var I = (u - l[L]) / $
                  , O = L < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
                if (p > i.longSwipesMs) {
                    if (!i.longSwipes)
                        return void t.slideTo(t.activeIndex);
                    "next" === t.swipeDirection && (I >= i.longSwipesRatio ? t.slideTo(L + O) : t.slideTo(L)),
                    "prev" === t.swipeDirection && (I > 1 - i.longSwipesRatio ? t.slideTo(L + O) : t.slideTo(L))
                } else {
                    if (!i.shortSwipes)
                        return void t.slideTo(t.activeIndex);
    ...
    var X = {
      ...
      , q = {
        ...
        update: {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== n) {
                    ...
                    for (var k, P, L, $ = s.slidesPerColumn, A = M / $, _ = Math.floor(h / s.slidesPerColumn), I = 0; I < h; I += 1) {
                        z = 0;
                        var O = p.eq(I);
                        if (s.slidesPerColumn > 1) {
                            ...
                            if ("row" === s.slidesPerColumnFill && s.slidesPerGroup > 1) {
                                var H = Math.floor(I / (s.slidesPerGroup * s.slidesPerColumn))
                                  , G = I - s.slidesPerColumn * s.slidesPerGroup * H
                                  , X = 0 === H ? s.slidesPerGroup : Math.min(Math.ceil((h - H * $ * s.slidesPerGroup) / $), s.slidesPerGroup);
                                D = (B = G - (N = Math.floor(G / X)) * X + H * s.slidesPerGroup) + N * M / $,
                                O.css({
                                ...
                                "column" === s.slidesPerColumnFill ? (N = I - (B = Math.floor(I / $)) * $,
                                (B > _ || B === _ && N === $ - 1) && (N += 1) >= $ && (N = 0,
                                B += 1)) : B = I - (N = Math.floor(I / A)) * A;
                            O.css(t("margin-top"), 0 !== N && s.spaceBetween && s.spaceBetween + "px")
                        }
                        if ("none" !== O.css("display")) {
                            if ("auto" === s.slidesPerView) {
                                var q = i.getComputedStyle(O[0], null)
                                  , Y = O[0].style.transform
                                  , R = O[0].style.webkitTransform;
                                if (Y && (O[0].style.transform = "none"),
                                R && (O[0].style.webkitTransform = "none"),
                                s.roundLengths)
                                    z = e.isHorizontal() ? O.outerWidth(!0) : O.outerHeight(!0);
                                else {
                                    var V = a(q, "width")
                                      , W = a(q, "padding-left")
                                      , F = a(q, "padding-right")
                                      , j = a(q, "margin-left")
                                      , U = a(q, "margin-right")
                                      , K = q.getPropertyValue(q, "box-sizing");
                                    if (K && "border-box" === K)
                                        z = V + j + U;
                                    else {
                                        var Z = O[0]
                                          , J = Z.clientWidth;
                                        z = V + W + F + j + U + (Z.offsetWidth - J)
                                    }
                                }
                            ...
                            v.push(z),
                            s.centeredSlides ? (x = x + z / 2 + C / 2 + E,
                            0 === C && 0 !== I && (x = x - n / 2 - E),
                            0 === I && (x = x - n / 2 - E),
                            Math.abs(x) < .001 && (x = 0),
                            s.roundLengths && (x = Math.floor(x)),
                            T % s.slidesPerGroup == 0 && f.push(x),
                            m.push(x)) : (s.roundLengths && (x = Math.floor(x)),
                            (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && f.push(x),
                            m.push(x),
                            x = x + z + E),
                            e.virtualSize += z + E,
                            C = z,
                    ...
                    s.setWrapperSize && r.css(((P = {})[t("width")] = e.virtualSize + s.spaceBetween + "px",
                    P)),
                    s.slidesPerColumn > 1 && (e.virtualSize = (z + s.spaceBetween) * M,
                    ...
                    s.centeredSlides)) {
                        ...
                        for (var Q = 0; Q < f.length; Q += 1) {
                            ...
                            f[Q] < e.virtualSize + f[0] && k.push(ee)
                        }
                        f = k
                    }
                    if (!s.centeredSlides) {
                        ...
                        for (var te = 0; te < f.length; te += 1) {
                            ...
                            f[te] <= e.virtualSize - n && k.push(ae)
                        }
                        f = k,
            ...
            updateActiveIndex: function(e) {
                var t, a = this, i = a.rtlTranslate ? a.translate : -a.translate, s = a.slidesGrid, r = a.snapGrid, n = a.params, l = a.activeIndex, o = a.realIndex, d = a.snapIndex, u = e;
                if (void 0 === u) {
                    for (var c = 0; c < s.length; c += 1)
                        void 0 !== s[c + 1] ? i >= s[c] && i < s[c + 1] - (s[c + 1] - s[c]) / 2 ? u = c : i >= s[c] && i < s[c + 1] && (u = c + 1) : i >= s[c] && (u = c);
                    n.normalizeSlideIndex && (u < 0 || void 0 === u) && (u = 0)
                }
                if (r.indexOf(i) >= 0)
                    t = r.indexOf(i);
                else {
                    var p = Math.min(n.slidesPerGroupSkip, u);
                    t = p + Math.floor((u - p) / n.slidesPerGroup)
                }
            ...
            updateClickedSlide: function(e) {
                var t, a = this, i = a.params, s = v(e.target).closest("." + i.slideClass)[0], r = !1;
                if (s)
        ...
        translate: {
            ...
            setTranslate: function(e, t) {
                ...
                (0 === u ? 0 : (e - a.minTranslate()) / u) !== l && a.updateProgress(e),
            ...
            translateTo: function(e, t, a, i, s) {
                ...
                if (r.animating && n.preventInteractionOnTransition)
                    return !1;
                var o, d = r.minTranslate(), u = r.maxTranslate();
                if (o = i && e > d ? d : i && e < u ? u : e,
                r.updateProgress(o),
                n.cssMode) {
                    var c, p = r.isHorizontal();
                    return 0 === t ? l[p ? "scrollLeft" : "scrollTop"] = -o : l.scrollTo ? l.scrollTo(((c = {})[p ? "left" : "top"] = -o,
                    c.behavior = "smooth",
                    c)) : l[p ? "scrollLeft" : "scrollTop"] = -o,
                    !0
                }
        ...
        slide: {
            slideTo: function(e, t, a, i) {
                ...
                (c || l.initialSlide || 0) === (u || 0) && a && r.emit("beforeSlideChangeStart");
                var v, g = -o[m];
                ...
                l.normalizeSlideIndex)
                    for (var y = 0; y < d.length; y += 1) {
                        ...
                        void 0 !== d[y + 1] ? b >= w && b < E - (E - w) / 2 ? n = y : b >= w && b < E && (n = y + 1) : b >= w && (n = y)
                    }
                ...
                if (v = n > c ? "next" : n < c ? "prev" : "reset",
                p && -g === r.translate || !p && g === r.translate)
                    return r.updateActiveIndex(n),
                    l.autoHeight && r.updateAutoHeight(),
                    r.updateSlidesClasses(),
                    "slide" !== l.effect && r.setTranslate(g),
                    "reset" !== v && (r.transitionStart(a, v),
                    r.transitionEnd(a, v)),
                    !1;
                if (l.cssMode) {
                    var x, C = r.isHorizontal(), T = -g;
                    return p && (T = h.scrollWidth - h.offsetWidth - T),
                    0 === t ? h[C ? "scrollLeft" : "scrollTop"] = T : h.scrollTo ? h.scrollTo(((x = {})[C ? "left" : "top"] = T,
                    x.behavior = "smooth",
                    x)) : h[C ? "scrollLeft" : "scrollTop"] = T,
                    !0
                }
                return 0 === t ? (r.setTransition(0),
                r.setTranslate(g),
                ...
                r.transitionEnd(a, v)) : (r.setTransition(t),
                r.setTranslate(g),
                r.updateActiveIndex(n),
                r.updateSlidesClasses(),
                r.emit("beforeTransitionStart", t, i),
            ...
            slidePrev: function(e, t, a) {
                ...
                var u = d(o ? i.translate : -i.translate)
                  , c = n.map((function(e) {
                    return d(e)
                }
                ));
                n[c.indexOf(u)];
                var p, h = n[c.indexOf(u) - 1];
            ...
            slideToClosest: function(e, t, a, i) {
                ...
                if (o >= s.snapGrid[l]) {
                    ...
                    var u = s.snapGrid[l - 1];
                    o - u <= (s.snapGrid[l] - u) * i && (r -= s.params.slidesPerGroup)
                }
        ...
        loop: {
            loopCreate: function() {
                ...
                for (var c = 0; c < u.length; c += 1)
                    i.append(v(u[c].cloneNode(!0)).addClass(a.slideDuplicateClass));
                for (var p = d.length - 1; p >= 0; p -= 1)
                    i.prepend(v(d[p].cloneNode(!0)).addClass(a.slideDuplicateClass))
            },
            loopFix: function() {
                var e = this;
        ...
        events: {
            attachEvents: function() {
                ...
                if (!o.touch && o.pointerEvents)
                    ...
                    if (o.touch) {
                        var u = !("touchstart" !== i.start || !o.passiveListener || !a.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                        s.addEventListener(i.start, e.onTouchStart, u),
                        s.addEventListener(i.move, e.onTouchMove, o.passiveListener ? {
                            passive: !1,
                            capture: d
                        } : d),
                        s.addEventListener(i.end, e.onTouchEnd, u),
                        i.cancel && s.addEventListener(i.cancel, e.onTouchEnd, u),
                        H || (t.addEventListener("touchstart", G),
                        H = !0)
                    }
                ...
                a.updateOnWindowResize ? e.on(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D, !0) : e.on("observerUpdate", D, !0)
            },
            detachEvents: function() {
                ...
                if (!o.touch && o.pointerEvents)
                    ...
                    if (o.touch) {
                        var u = !("onTouchStart" !== i.start || !o.passiveListener || !a.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                        ...
                        i.cancel && s.removeEventListener(i.cancel, e.onTouchEnd, u)
                    }
                ...
                e.off(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D)
            }
        },
        breakpoints: {
            setBreakpoint: function() {
                ...
                if (l && (!l || 0 !== Object.keys(l).length)) {
                    ...
                    if (o && e.currentBreakpoint !== o) {
                        ...
                        c && !p ? (n.removeClass(r.containerModifierClass + "multirow " + r.containerModifierClass + "multirow-column"),
                        e.emitContainerClasses()) : !c && p && (n.addClass(r.containerModifierClass + "multirow"),
                        "column" === u.slidesPerColumnFill && n.addClass(r.containerModifierClass + "multirow-column"),
        ...
        classes: {
            addClasses: function() {
                var e, t, a, i = this, s = i.classNames, r = i.params, n = i.rtl, l = i.$el, o = i.device, d = i.support, u = (e = ["initialized", r.direction, {
        ...
        images: {
            loadImage: function(e, t, a, i, s, r) {
                ...
                v(e).parent("picture")[0] || e.complete && s ? d() : t ? ((n = new o.Image).onload = d,
                n.onerror = d,
                i && (n.sizes = i),
                a && (n.srcset = a),
                t && (n.src = t)) : d()
      ...
      , R = function() {
        ...
        s.mount = function(e) {
            ...
            if (t.mounted)
                return !0;
            var a, i = v(e || t.params.el);
            return !!(e = i[0]) && (e.swiper = t,
            e && e.shadowRoot && e.shadowRoot.querySelector ? (a = v(e.shadowRoot.querySelector("." + t.params.wrapperClass))).children = function(e) {
                return i.children(e)
            }
    ...
    var V = {
        update: function(e) {
            ...
            for (var k = 0; k < p.length; k += 1)
                k >= w && k <= E && (void 0 === c || e ? M.push(k) : (k > c && M.push(k),
                k < u && T.push(k)));
      ...
      , F = {
        handle: function(e) {
            ...
            var o = n.keyCode || n.charCode
              ...
              , f = 38 === o
              , m = 40 === o;
            if (!t.allowSlideNext && (t.isHorizontal() && h || t.isVertical() && m || c))
                return !1;
            ...
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (u || c || p || h || f || m)) {
                    ...
                    var g = a.innerWidth
                      , y = a.innerHeight
                      , b = t.$el.offset();
                    s && (b.left -= t.$el[0].scrollLeft);
                    for (var w = [[b.left, b.top], [b.left + t.width, b.top], [b.left, b.top + t.height], [b.left + t.width, b.top + t.height]], E = 0; E < w.length; E += 1) {
                        var x = w[E];
                ...
                t.isHorizontal() ? ((u || c || p || h) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                ((c || h) && !s || (u || p) && s) && t.slideNext(),
                ((u || p) && !s || (c || h) && s) && t.slidePrev()) : ((u || c || f || m) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                (c || m) && t.slideNext(),
                (u || f) && t.slidePrev()),
                t.emit("keyPress", o)
            }
        ...
        enable: function() {
            var e = this
              , t = r();
            e.keyboard.enabled || (v(t).on("keydown", e.keyboard.handle),
            e.keyboard.enabled = !0)
        },
        disable: function() {
            var e = this
              , t = r();
            e.keyboard.enabled && (v(t).off("keydown", e.keyboard.handle),
      ...
      , U = {
        ...
        handle: function(e) {
            ...
            var s = a.$el;
            if ("container" !== a.params.mousewheel.eventsTarget && (s = v(a.params.mousewheel.eventsTarget)),
            ...
            a.params.freeMode) {
                ...
                if (C.push(w),
                T ? (w.direction !== T.direction || w.delta > T.delta || w.time > T.time + 150) && a.mousewheel.animateSlider(w) : a.mousewheel.animateSlider(w),
        ...
        enable: function() {
            ...
            if (e.mousewheel.enabled)
                return !1;
            var a = e.$el;
            return "container" !== e.params.mousewheel.eventsTarget && (a = v(e.params.mousewheel.eventsTarget)),
        ...
        update: function() {
            ...
            if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                ...
                "bullets" === a.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                    var l, o, d, u = e.pagination.bullets;
                    ...
                    d = ((o = l + (Math.min(u.length, a.dynamicMainBullets) - 1)) + l) / 2),
                    ...
                    r.length > 1)
                        ...
                        a.dynamicBullets) {
                            for (var h = u.eq(l), f = u.eq(o), m = l; m <= o; m += 1)
                                u.eq(m).addClass(a.bulletActiveClass + "-main");
                            if (e.params.loop)
                ...
                "progressbar" === a.type) {
                    ...
                    var x = (i + 1) / n
                      , C = 1
                      , T = 1;
                    "horizontal" === E ? C = x : T = x,
                    r.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + C + ") scaleY(" + T + ")").transition(e.params.speed)
                }
      ...
      , J = {
        setTranslate: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                var t = e.scrollbar
                  ...
                  , u = (r - s) * i;
                a ? (u = -u) > 0 ? (d = s - u,
                u = 0) : -u + s > r && (d = r + u) : u < 0 ? (d = s + u,
                u = 0) : u + s > r && (d = r - u),
                e.isHorizontal() ? (n.transform("translate3d(" + u + "px, 0, 0)"),
                n[0].style.width = d + "px") : (n.transform("translate3d(0px, " + u + "px, 0)"),
        ...
        enableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                var t = r()
                  ...
                  , u = !(!l.passiveListener || !n.passiveListeners) && {
                    passive: !0,
                    capture: !1
                };
                o && (l.touch ? (o.addEventListener(i.start, e.scrollbar.onDragStart, d),
                o.addEventListener(i.move, e.scrollbar.onDragMove, d),
                o.addEventListener(i.end, e.scrollbar.onDragEnd, u)) : (o.addEventListener(s.start, e.scrollbar.onDragStart, d),
        ...
        disableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                o.removeEventListener(i.end, e.scrollbar.onDragEnd, u)) : (o.removeEventListener(s.start, e.scrollbar.onDragStart, d),
        ...
        init: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                0 === r.length && (r = v('<div class="' + e.params.scrollbar.dragClass + '"></div>'),
                s.append(r)),
                S(t, {
                    $el: s,
                    el: s[0],
      ...
      , Q = {
        ...
        setTranslate: function() {
            ...
            a.each((function(t, a) {
                ...
                v(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((function(t) {
      ...
      , ee = {
        ...
        onGestureStart: function(e) {
            ...
            r.$slideEl && r.$slideEl.length || (r.$slideEl = v(e.target).closest("." + t.params.slideClass),
        ...
        onTouchMove: function(e) {
            ...
            s.isTouched && i.$slideEl)) {
                ...
                s.startX = C(i.$imageWrapEl[0], "x") || 0,
                s.startY = C(i.$imageWrapEl[0], "y") || 0,
        ...
        in: function(e) {
            var t, a, i, s, r, n, o, d, u, c, p, h, f, m, v, g, y = this, b = l(), w = y.zoom, E = y.params.zoom, x = w.gesture, C = w.image;
            ...
            i = x.$slideEl.offset().left + b.scrollX + v / 2 - t,
            s = x.$slideEl.offset().top + b.scrollY + g / 2 - a,
      ...
      , te = {
        ...
        load: function() {
            ...
            e.params.watchSlidesVisibility)
                ...
                for (var u = s; u < s + l; u += 1)
                    o(u) && e.lazy.loadInSlide(u);
            else
                e.lazy.loadInSlide(s);
            if (n.loadPrevNext)
                if (l > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                    for (var c = n.loadPrevNextAmount, p = l, h = Math.min(s + p + Math.max(c, p), i.length), f = Math.max(s - Math.max(p, c), 0), m = s + l; m < h; m += 1)
        ...
        checkInViewOnLoad: function() {
            ...
            if (t && !t.destroyed) {
                ...
                for (var d = [[n.left, n.top], [n.left + t.width, n.top], [n.left, n.top + t.height], [n.left + t.width, n.top + t.height]], u = 0; u < d.length; u += 1) {
                    var c = d[u];
      ...
      , ie = {
        ...
        init: function() {
            ...
            t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription(v(e.slides), t.itemRoleDescriptionMessage),
            e.a11y.addElRole(v(e.slides), "group"),
      ...
      , re = {
        ...
        init: function() {
            ...
            if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                ...
                e.params.hashNavigation.watchState && v(a).on("hashchange", e.hashNavigation.onHashCange)
            }
        },
        destroy: function() {
            var e = l();
      ...
      , oe = {
        setTranslate: function() {
            var e, t = this, a = t.$el, i = t.$wrapperEl, s = t.slides, r = t.width, n = t.height, l = t.rtlTranslate, o = t.size, d = t.browser, u = t.params.cubeEffect, c = t.isHorizontal(), p = t.virtual && t.params.virtual.enabled, h = 0;
            u.shadow && (c ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = v('<div class="swiper-cube-shadow"></div>'),
            i.append(e)),
            e.css({
                height: r + "px"
            })) : 0 === (e = a.find(".swiper-cube-shadow")).length && (e = v('<div class="swiper-cube-shadow"></div>'),
            a.append(e)));
            for (var f = 0; f < s.length; f += 1) {
                ...
                g % 4 == 0 ? (E = 4 * -b * o,
                C = 0) : (g - 1) % 4 == 0 ? (E = 0,
                C = 4 * -b * o) : (g - 2) % 4 == 0 ? (E = o + 4 * b * o,
                C = o) : (g - 3) % 4 == 0 && (E = -o,
                C = 3 * o + 4 * o * b),
                l && (E = -E),
                c || (x = E,
                E = 0);
                var T = "rotateX(" + (c ? 0 : -y) + "deg) rotateY(" + (c ? y : 0) + "deg) translate3d(" + E + "px, " + x + "px, " + C + "px)";
                ...
                u.slideShadows) {
                    ...
                    0 === S.length && (S = v('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'),
                    m.append(S)),
                    0 === M.length && (M = v('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'),
                    m.append(M)),
            ...
            u.shadow)
                if (c)
                    ...
                    var z = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90)
                      ...
                      , L = u.shadowScale / k
                      , $ = u.shadowOffset;
                    e.transform("scale3d(" + P + ", 1, " + L + ") translate3d(0px, " + (n / 2 + $) + "px, " + -n / 2 / L + "px) rotateX(-90deg)")
                }
            var A = d.isSafari || d.isWebView ? -o / 2 : 0;
            i.transform("translate3d(0px,0," + A + "px) rotateX(" + (t.isHorizontal() ? 0 : h) + "deg) rotateY(" + (t.isHorizontal() ? -h : 0) + "deg)")
        },
        setTransition: function(e) {
            var t = this
              , a = t.$el;
        ...
        setTranslate: function() {
            for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
                ...
                e.params.flipEffect.slideShadows) {
                    ...
                    0 === u.length && (u = v('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'),
                    s.append(u)),
                    0 === c.length && (c = v('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'),
                    s.append(c)),
      ...
      , ue = {
        setTranslate: function() {
            for (var e = this, t = e.width, a = e.height, i = e.slides, s = e.slidesSizesGrid, r = e.params.coverflowEffect, n = e.isHorizontal(), l = e.translate, o = n ? t / 2 - l : a / 2 - l, d = n ? r.rotate : -r.rotate, u = r.depth, c = 0, p = i.length; c < p; c += 1) {
                var h = i.eq(c)
                  , f = s[c]
                  , m = (o - h[0].swiperSlideOffset - f / 2) / f * r.modifier
                  , g = n ? d * m : 0
                  , y = n ? 0 : d * m
                  , b = -u * Math.abs(m)
                  , w = r.stretch;
                ...
                Math.abs(y) < .001 && (y = 0),
                Math.abs(C) < .001 && (C = 0);
                var T = "translate3d(" + x + "px," + E + "px," + b + "px)  rotateX(" + y + "deg) rotateY(" + g + "deg) scale(" + C + ")";
                if (h.transform(T),
                h[0].style.zIndex = 1 - Math.abs(Math.round(m)),
                r.slideShadows) {
                    var S = n ? h.find(".swiper-slide-shadow-left") : h.find(".swiper-slide-shadow-top")
                      , M = n ? h.find(".swiper-slide-shadow-right") : h.find(".swiper-slide-shadow-bottom");
                    0 === S.length && (S = v('<div class="swiper-slide-shadow-' + (n ? "left" : "top") + '"></div>'),
                    h.append(S)),
                    0 === M.length && (M = v('<div class="swiper-slide-shadow-' + (n ? "right" : "bottom") + '"></div>'),
                    h.append(M)),
        ...
        onThumbClick: function() {
            ...
            if (t) {
                var a = t.clickedIndex
                  , i = t.clickedSlide;
                if (!(i && v(i).hasClass(e.params.thumbs.slideThumbActiveClass) || null == a)) {
                    var s;
                    if (s = t.params.loop ? parseInt(v(t.clickedSlide).attr("data-swiper-slide-index"), 10) : a,
                    e.params.loop) {
                        var r = e.activeIndex;
        ...
        update: function(e) {
            ...
            if (a) {
                ...
                if (t.realIndex !== a.realIndex || r) {
                    ...
                    if (a.params.loop) {
                        ...
                        var d = a.slides.eq(o).prevAll('[data-swiper-slide-index="' + t.realIndex + '"]').eq(0).index()
                          , u = a.slides.eq(o).nextAll('[data-swiper-slide-index="' + t.realIndex + '"]').eq(0).index();
                        n = void 0 === d ? u : void 0 === u ? d : u - o == o - d ? o : u - o < o - d ? u : d,
                ...
                a.params.loop || a.params.virtual && a.params.virtual.enabled)
                    for (var h = 0; h < c; h += 1)
                        a.$wrapperEl.children('[data-swiper-slide-index="' + (t.realIndex + h) + '"]').addClass(p);
                else
                    for (var f = 0; f < c; f += 1)
        ...
        on: {
            ...
            click: function(e, t) {
                var a = e.navigation
                  ...
                  , s = a.$prevEl
                  , r = t.target;
                if (e.params.navigation.hideOnClick && !v(r).is(s) && !v(r).is(i)) {
