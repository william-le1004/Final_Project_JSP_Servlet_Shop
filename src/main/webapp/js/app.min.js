...
DynamicAdapt.prototype.moveBack = function(e, t, n) {
    ...
    void 0 !== e.children[n] ? e.children[n].insertAdjacentElement("beforebegin", t) : e.insertAdjacentElement("beforeend", t)
}
,
...
if (sliders) {
    for (let e = 0; e < sliders.length; e++) {
        ...
        if (!t.classList.contains("swiper-bild")) {
            ...
            if (i.classList.add("swiper-wrapper"),
            i.innerHTML = n,
            t.innerHTML = "",
            t.appendChild(i),
...
document.querySelector(".slider-rooms__body") && new Swiper(".slider-rooms__body",{
    observer: !0,
    observeParents: !0,
    slidesPerView: "auto",
    spaceBetween: 24,
...
document.querySelector(".slider-tips__body") && new Swiper(".slider-tips__body",{
    observer: !0,
    observeParents: !0,
    slidesPerView: 3,
    spaceBetween: 32,
...
if (spollersArray.length > 0) {
    ...
    function setSpollerAction(e) {
        ...
        if (t.hasAttribute("data-spoller") || t.closest("[data-spoller]")) {
            ...
            i.querySelectorAll("._slide").length || (l && !n.classList.contains("_active") && hideSpollersBody(i),
...
function digi_animate(e) {
    if (e.length > 0)
        for (let t = 0; t < e.length; t++) {
            const n = e[t]
              , i = parseInt(n.innerHTML.replace(" ", ""));
            n.classList.contains("_done") || digi_animate_value(n, 0, i, 1500)
        }
}
function digi_animate_value(e, t, n, i) {
    var l = e
      , o = n - t
      , s = Math.abs(Math.floor(i / o));
    s = Math.max(s, 50);
...
if (moreBlocks.length > 0) {
    ...
    for (let t = 0; t < moreBlocks.length; t++) {
        ...
        let i = n.querySelectorAll("._more-item");
        if (i.length > 0) {
            let t, l = n.querySelector("._more-link"), o = n.querySelector("._more-content"), s = o.getAttribute("data-view");
            function setSize(n) {
                let l, r = 0, a = 0;
                for (let e = 0; e < i.length; e++)
                    e < s && (r += i[e].offsetHeight),
                    a += i[e].offsetHeight;
                l = "start" === n ? a : r,
            ...
            function updateSize() {
                ...
                (0 === t && n > 0 || t > 0 && 0 === n) && (l.classList.contains("_active") ? setSize("start") : setSize())
            }
            "0s" === getComputedStyle(o).getPropertyValue("transition-duration") && (o.style.cssText = "transition-duration: 1ms"),
            l.addEventListener("click", (function(e) {
                l.classList.contains("_active") ? setSize() : setSize("start"),
                l.classList.toggle("_active"),
                e.preventDefault()
            }
            )),
            o.addEventListener("transitionend", updateSize, !1),
        ...
        e.classList.contains("rating_set") && function(e) {
            ...
            for (let s = 0; s < n.length; s++) {
                ...
                r.addEventListener("click", (function(n) {
                    i(e),
                    e.dataset.ajax ? o(r.value, e) : (t.innerHTML = s + 1,
                    l())
                }
                ))
            }
...
function animate({timing: e, draw: t, duration: n}) {
    ...
    requestAnimationFrame((function l(o) {
        let s = (o - i) / n;
        s > 1 && (s = 1);
        let r = e(s);
        t(r),
        s < 1 && requestAnimationFrame(l)
    }
    ))
}
...
window.onload = function() {
    document.addEventListener("click", (function(e) {
        const n = e.target;
        n.classList.contains("menu__arrow") && n.closest(".menu__item").classList.toggle("_hover");
        n.classList.contains("search-form__icon") ? document.querySelector(".search-form").classList.toggle("_active") : !n.closest(".search-form") && document.querySelector(".search-form._active") && document.querySelector(".search-form").classList.remove("_active");
        n.classList.contains("products__more") && (!async function(e) {
                    ...
                    !function(e) {
                        ...
                        e.products.forEach((e=>{
                            const n = e.id
                              ...
                              , d = e.likeUrl
                              , u = e.labels;
                            let p = `<div data-pid="${n}" class="products__item item-product">`
                              , m = "</div>"
                              , _ = "";
                            if (u) {
                                let e = '<div class="item-product__labels">'
                                  ...
                                  , n = "";
                                u.forEach((e=>{
                                    n += `<div class="item-product__label item-product__label_ ${e.type}">${e.value}</div>`
                                }
                                )),
                                _ += e,
                                _ += n,
                            ...
                            let f = "";
                            f = '<div class="item-product__prices">',
                            f += `<div class="item-product__price">Rp ${r}</div>`,
                            a && (f += `<div class="item-product__price item-product__price_old">Rp ${a}</div>`),
                            f += "</div>";
                            let y = "";
                            y += '<div class="item-product__body">',
        ...
        e.preventDefault());
        if (n.classList.contains("actions-product__btn")) {
            const i = n.closest(".item-product").dataset.pid;
            !function(e, n) {
                if (!e.classList.contains("_hold")) {
                    e.classList.add("_hold"),
                    e.classList.add("_fly");
                    const i = document.querySelector(".cart-header__icon")
                      , l = document.querySelector(`[data-pid="${n}"]`).querySelector(".item-product__img")
                      , o = l.cloneNode(!0)
                      , s = l.offsetWidth
                      , r = l.offsetHeight
                      , a = l.getBoundingClientRect().top
                      , c = l.getBoundingClientRect().left;
                    o.setAttribute("class", "_flyImage _ibg"),
                    o.style.cssText = `\n\t\t\tleft: ${c}px;\n\t\t\ttop: ${a}px;\n\t\t\twidth: ${s}px;\n\t\t\theight: ${r}px;\n\t\t`,
                    document.body.append(o);
                    const d = i.getBoundingClientRect().left
                      , u = i.getBoundingClientRect().top;
                    o.style.cssText = `\n\t\t\tleft: ${d}px;\n\t\t\ttop: ${u}px;\n\t\t\twidth: 0px;\n\t\t\theight: 0px;\n\t\t\topacity:0;\n\t\t`,
                    o.addEventListener("transitionend", (function() {
                        e.classList.contains("_fly") && (o.remove(),
                        t(e, n),
        ...
        n.classList.contains("cart-header__icon") || n.closest(".cart-header__icon") ? (document.querySelector(".cart-list").children.length > 0 && document.querySelector(".cart-header").classList.toggle("_active"),
        e.preventDefault()) : n.closest(".cart-header") || n.classList.contains("actions-product__button") || document.querySelector(".cart-header").classList.remove("_active");
        if (n.classList.contains("cart-list__delete")) {
            const i = n.closest(".cart-list__item").dataset.cartPid;
            t(n, i, !1),
            e.preventDefault()
        }
    }
    ...
    document.documentElement.addEventListener("click", (function(e) {
        e.target.closest(".menu__item._hover") || _removeClasses(document.querySelectorAll(".menu__item"), "_hover")
    }
    ));
    const e = document.querySelector(".header");
    function t(e, t, n=!0) {
        const i = document.querySelector(".cart-header")
          , l = i.querySelector(".cart-header__icon")
          , o = l.querySelector("span")
          , s = document.querySelector(`[data-cart-pid="${t}"]`)
          , r = document.querySelector(".cart-list");
        if (n) {
            if (o ? o.innerHTML = ++o.innerHTML : l.insertAdjacentHTML("beforeend", "<span>1</span>"),
            s) {
                const e = s.querySelector(".cart-list__quantity span");
                ...
                r.insertAdjacentHTML("beforeend", `<li data-cart-pid="${t}" class="cart-list__item">${n}</li>`)
            }
            e.classList.remove("_hold")
        } else {
            const e = s.querySelector(".cart-list__quantity span");
            e.innerHTML = --e.innerHTML,
            parseInt(e.innerHTML) || s.remove();
            const t = --o.innerHTML;
            t ? o.innerHTML = t : (o.remove(),
    ...
    const n = document.querySelector(".furniture__body");
    if (n && !isMobile.any()) {
        ...
        function i() {
            ...
            const a = r - n.offsetWidth
              , c = Math.floor(s - o);
            o += c * l;
            let d = a / 200 * o;
            e.style.cssText = `transform: translate3d(${-d}px,0,0);`,
            Math.abs(c) > 0 ? requestAnimationFrame(i) : n.classList.remove("_init")
        }
        n.addEventListener("mousemove", (function(e) {
            const t = n.offsetWidth
              , l = e.pageX - t / 2;
            s = l / t * 200,
            n.classList.contains("_init") || (requestAnimationFrame(i),
            n.classList.add("_init"))
        }
        ))
    }
}
...
async function form_submit(e) {
    ...
    if (0 == form_validate(t)) {
        let n = t.getAttribute("action") ? t.getAttribute("action").trim() : "#"
          , i = t.getAttribute("method") ? t.getAttribute("method").trim() : "GET";
...
function form_validate(e) {
    ...
    if (n.length > 0)
        for (let e = 0; e < n.length; e++) {
            const i = n[e];
            _is_hidden(i) || (t += form_validate_input(i))
        }
    return t
}
...
function select_init(e) {
    const t = e.parentElement
      ...
      , i = e.querySelector("option:checked");
    e.setAttribute("data-default", i.value),
...
function select_item(e) {
    ...
    n && n.remove();
    let s = "";
    s = "input" == o ? '<div class="select__value icon-select-arrow"><input autocomplete="off" type="text" name="form[]" value="' + l + '" data-error="Ошибка" data-value="' + l + '" class="select__input"></div>' : '<div class="select__value icon-select-arrow"><span>' + l + "</span></div>",
    t.insertAdjacentHTML("beforeend", '<div class="select__item"><div class="select__title">' + s + '</div><div hidden class="select__options">' + select_get_options(i) + "</div></div></div>"),
    select_actions(e, t)
}
function select_actions(e, t) {
    const n = t.querySelector(".select__item")
      , i = t.querySelector(".select__title")
      , l = t.querySelector(".select__options")
      , o = t.querySelectorAll(".select__option")
      , s = e.getAttribute("data-type")
      , r = t.querySelector(".select__input");
    function a() {
        let n = t.querySelectorAll(".select__option")
          , i = e.querySelectorAll("option")
          , l = [];
        for (let e = 0; e < n.length; e++) {
            const t = n[e];
            if (i[e].removeAttribute("selected"),
            t.classList.contains("_selected")) {
                const n = t.innerHTML;
                l.push(n),
                i[e].setAttribute("selected", "selected")
            }
        }
    ...
    function c(e) {
        if (!e) {
            ...
            for (let t = 0; t < e.length; t++) {
                const i = e[t]
                  , l = i.querySelector(".select__options");
                i != n.closest(".select") && (i.classList.remove("_active"),
                _slideUp(l, 100))
            }
            _slideToggle(l, 100),
            t.classList.toggle("_active")
    ...
    for (let n = 0; n < o.length; n++) {
        const i = o[n]
          ...
          , d = i.innerHTML;
        "input" == s ? r.addEventListener("keyup", select_search) : i.getAttribute("data-value") != e.value || e.hasAttribute("multiple") || (i.style.display = "none"),
        i.addEventListener("click", (function() {
            ...
            let n;
            "input" == s ? (r.value = d,
            e.value = l) : e.hasAttribute("multiple") ? (i.classList.toggle("_selected"),
            a()) : (t.querySelector(".select__value").innerHTML = "<span>" + d + "</span>",
            e.value = l,
    ...
    if (e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const i = e[n]
              , l = i.value;
            if ("" != l) {
                t = t + '<div data-value="' + l + '" class="select__option">' + i.innerHTML + "</div>"
            }
        }
        return t
    }
...
function select_search(e) {
    ...
    for (let e = 0; e < t.length; e++) {
        let i = t[e];
        (i.textContent || i.innerText).toUpperCase().indexOf(n) > -1 ? i.style.display = "" : i.style.display = "none"
    }
}
...
function inputs_init(e) {
    if (e.length > 0)
        for (let t = 0; t < e.length; t++) {
            ...
            "" != n.value && n.value != i && input_focus_add(n),
            n.addEventListener("focus", (function(e) {
                n.value == i && (input_focus_add(n),
                n.value = ""),
            ...
            n.addEventListener("blur", (function(e) {
                ...
                n.classList.contains("_mask") && input_clear_mask(n, i),
            ...
            n.classList.contains("_date")) {
                const e = datepicker(n, {
                  ...
                  , i = n.getAttribute("data-to");
                t && e.setMin(new Date(t)),
                i && e.setMax(new Date(i))
            }
        }
}
...
if (quantityButtons.length > 0)
    for (let e = 0; e < quantityButtons.length; e++) {
        ...
        t.addEventListener("click", (function(e) {
            ...
            t.classList.contains("quantity__button_plus") ? n++ : (n -= 1,
            n < 1 && (n = 1)),
...
if (priceSlider) {
    ...
    function setPriceValues() {
        let e, t;
        "" != priceStart.value && (e = priceStart.value),
        "" != priceEnd.value && (t = priceEnd.value),
        priceSlider.noUiSlider.set([e, t])
    }
