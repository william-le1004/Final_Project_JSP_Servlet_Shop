    ...
    <div class="container mt-5">
        ...
        <div class="row" style="margin-top: 0px; display: flex; margin-left: 40px;">
            ...
            <div class="col-md-6 mb-4">
                <img src="./images/${product.productImg}" class="img-fluid" alt=""
                     style="width: 300px; margin-top: 20px; margin-left: 40px;border: solid #B88E2F 2px; padding: 5px; border-radius: 10px;"/>
            </div>
            <!--Grid column-->
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="p-4" style="margin-left: 100px; margin-top: 30px;">
                    ...
                    <p style="font-weight: bold; font-size: 24px; color: #B88E2F; border: 1px solid #B88E2F; width: 100px; padding: 7px; border-radius: 10px; margin-top: 40px">
                        RATING</p>
                    ...
                    <form class="d-flex justify-content-left" style="margin-top: 50px;">
                        ...
                        <div class="form-outline me-1" style="width: 20px; margin-right: 25px;">
                            <input type="number" value="1" class="form-control"
                                   style="text-align: center; width: 50px; height: 30px; border-radius: 10px; font-size: 24px; margin-left: 26px; margin-top: 20px;"/>
                        </div>
                        <button class="btn btn-primary ms-1" type="submit"
                                style="background-color: #B88E2F; border-color: #B88E2F; width: 200px; height: 40px; margin-top: 40px; border-radius: 10px;">
                            <a href="${pageContext.request.contextPath}/addCart?id=${product.productID}&action=addCart"
                               class="btn"
                               style="font-weight: bold; color: white; text-decoration: none; font-size: 16px;">
                                Add to cart
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-6 text-center">
                <h4 class="my-4 h4" style="font-weight: bold; font-size: 32px; margin-left: 360px;">RELATED
                    PRODUCTS</h4>
            </div>
            <!--Grid column-->
        </div>
        ...
        <div class="row" style="margin-top: 40px; margin-left: 260px; margin-bottom: 100px; display: flex;">
            ...
            <div class="col-lg-4 col-md-12 mb-4">
                <a href=""><img src="./Image/macbook_air.jpg" class="img-fluid" alt=""
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <a href=""><img src="./Image/iphone11.jpg" class="img-fluid" alt=""
                                style="width: 200px; height: 200px;"/></a>
            </div>
            <!--Grid column-->
            ...
            <!--Grid column-->
            <div class="col-lg-4 col-md-6 mb-4">
                <a href=""><img src="./Image/ipad_pro.jpg" class="img-fluid" alt=""
                                style="width: 200px; height: 200px;"/></a>
            </div>
            <!--Grid column-->
        </div>
