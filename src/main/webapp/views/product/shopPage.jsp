    ...
    <div class="div" style="display: flex; margin-left: 98px; margin-bottom: 10px; margin-top: 30px;">
        ...
        <div class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
                ...
                <a href="${pageContext.request.contextPath}/shop?action=high&">High → Low Price</a>
                ...
                <div class="el-wrapper" style="margin-right: 20px;">
                    <div class="box-up">
                        ...
                        <div class="img-info">
                            ...
                            <div class="a-size">${o.quantity}</div>
                        </div>
                    </div>
                ...
                <span class="txt" style="font-size: 20px; margin-left: 40px;">
                    ...
                    <div style="margin-top: 30px; margin-left: 60px;">
                        ...
                        <button style="width: 100px; height: 40px; background-color: #B88E2F; color: white; font-weight: bold; border-radius: 10px; cursor: pointer;">
                            <a href="${pageContext.request.contextPath}/addCart?id=${o.productID}&action=addCart"
                               class="btn"
                               style="font-weight: bold; color: white; text-decoration: none;font-size: 10px;">Add to
                                cart</a></button>
                    </div>
                </div>
            </c:forEach>
