...
<div class="header">
    <div class="group">
        <div class="overlap-group">
            <div class="div">
                <div class="text-wrapper" style="z-index: 10;"><a href="${pageContext.request.contextPath}/admin"> Admin Home </a></div>
                <div class="text-wrapper-4"><a href="${pageContext.request.contextPath}/productManagement"> Management Product </a></div>
            </div>
            ...
            <div class="group-2">
                ...
                <div class="frame_header">
                    <a href="HomePage.jsp"><img class="meubel-house-logos" alt="Meubel house logos"
                                                src="./Image/meubel-house-logos-05.png"/></a>
                    <a href="HomePage.jsp"><img class="skin-clinic" alt="Skin clinic"
