...
<div class="header">
    <div class="group">
        <div class="overlap-group">
            <div class="div">
                <div class="text-wrapper" style="z-index: 10;"><a href="${pageContext.request.contextPath}/home">Home</a></div>
                <div class="text-wrapper-2"><a href="${pageContext.request.contextPath}/shop">Shop</a></div>
                <div class="text-wrapper-3"><a href="./views/user/blogPage.jsp">About</a></div>
                <div class="text-wrapper-4"><a href="./views/user/contactPage.jsp">Contact</a></div>
            </div>


            <div class="group-2">
                <a href="#"><img class="mdi-account-alert" alt="Mdi account alert"
                ...
                <a href="./views/product/cartPage.jsp"><img class="ant-design-shopping" alt="Ant design shopping"
                                               src="./Image/ant-design-shopping-cart-outlined.svg"/></a>


                <div class="frame_header">
                    <a href="${pageContext.request.contextPath}/home"><img class="meubel-house-logos" alt="Meubel house logos"
