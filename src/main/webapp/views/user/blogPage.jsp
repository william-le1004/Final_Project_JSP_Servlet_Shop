...
<div class="content">
    <div class="text">
        ...
        <h5><a href="${pageContext.request.contextPath}/home" style="color: black; text-decoration: none;"> Home </a> >
            <a href="BlogPage.jsp" style="color: black; text-decoration: none;">Blog </a></h5>
    </div>
</div>

<!-------------------------------------->
<div class="blog_content" style="display: flex; margin-left: 170px; margin-bottom: 100px;">
    <div class="left_content" style="margin-top: 40px; margin-left: 100px;">

        <div class="left_content_1" style="width: 400px;">
            <a href="https://www.apple.com/newsroom/2022/10/apple-introduces-next-generation-ipad-pro-supercharged-by-the-m2-chip/"><img
                    src="./Image/ipad_pro.jpg" style="width: 200px;"></a>
            <a href="https://www.apple.com/newsroom/2022/10/apple-introduces-next-generation-ipad-pro-supercharged-by-the-m2-chip/"
               style="color: black; text-decoration: none;">
                <h3 style="margin-top: 40px;">About Ipad Pro M2</h3>
            </a>
            <h6 style="text-align: justify; line-height: 25px; color: #9F9F9F;">The new iPad Pro features a next-level
                Apple Pencil hover experience, ProRes video capture, superfast Wi-Fi 6E, and powerful features in iPadOS
                16</h6>
        </div>

        <!-------------------------------->

        <div class="line" style="margin-bottom: 40px">_____________________________________</div>

        <!-------------------------------------------------------->
        <div class="left_content_2" style="width: 400px;">
            <a href="https://www.apple.com/iphone-14-pro/specs/"><img src="./Image/iphone14.webp" style="width: 200px;"></a>
            ...
            <h6 style="text-align: justify; line-height: 25px; color: #9F9F9F;">With Apple Trade In, you can get credit
                toward a new iPhone when you trade in an eligible smartphone. 25 It’s good for you and the planet.</h6>
        </div>
        ...
        <!--------------------------------------------------------------------->
        <div class="left_content_3" style="width: 400px;">
            <a href="https://www.apple.com/macbook-air-m1/"><img src="./Image/macbook_air.jpg"
                                                                 style="width: 200px;"></a>
            ...
            <h6 style="text-align: justify; line-height: 25px; color: #9F9F9F;">MacBook Air with M1 is an incredibly
                portable laptop — it’s nimble and quick, with a silent, fanless design and a beautiful Retina display.
                Thanks to its slim profile and all‑day battery life, this Air moves at the speed of lightness.</h6>
        </div>

    </div>


    <div class="right_content" style="margin-top: 55px; margin-left: 100px;">
        <div class="blog_right">
            <form class="search_bar">
                <input type="text" placeholder="Search here" style="width:311px; height: 38px; border-radius: 10px;">

                <button style="width:50px; height: 38px; background-color: white; border-color: white; cursor: pointer;">
                    <img src="./Image/akar-icons-search.svg"></button>
            </form>
        ...
        <div class="related_post" style="margin-top: 50px; margin-left: 40px;">
            ...
            <div class="related_post_1" style="display: flex; margin-bottom: 40px;">
                ...
                <a href="#"><h6 style="width: 180px; text-align: justify; margin-top: 35px; color: black;"> Iphone 11
                    and something you don't know </h6></a>
            </div>
            ...
            <div class="related_post_2" style="display: flex; margin-bottom: 40px;">
                ...
                <a href="#"><h6 style="width: 180px; text-align: justify; margin-top: 58px; color: black;"> About
                    Samsung S21+</h6></a>
            </div>
            ...
            <div class="related_post_3" style="display: flex; margin-bottom: 40px;">
                ...
                <a href="#"><h6 style="width: 180px; text-align: justify; margin-top: 66px; color: black;">Samsung S23
                    ultra</h6></a>
            </div>
        </div>
